  ...
  return (
    <div className="card bg-base-100">
      <div className="flex flex-col align-middle ">
        <div
          className="flex items-center gap-x-3 border-b
        ...
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setMapOpen(!mapOpen)} className="btn btn-info btn-outline mr-2">
      ...
      {mapOpen && event && (
        <div className="h-64">
          <MapComponent position={[event.latitude, event.longitude]} venue={event.venue} />
        </div>
      )}
    </div>
  );
