...
export default function EventDetailedSidebar() {
  ...
  return (
    <div className="card bg-base-100">
      <div
        className="card-title bg-gradient-to-r 
    from-primary to-black py-2 text-white justify-center rounded-t-lg"
      >
        ...
        <div className="flex flex-col gap-3">
          {event?.attendees.map((attendee, index) => (
            <Fragment key={attendee.id}>
              <div className="flex gap-3 justify-between align-middle items-center">
