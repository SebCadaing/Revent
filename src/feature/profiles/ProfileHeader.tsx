        ...
        <div className=" flex items-center gap-3">
          ...
          <div className="flex flex-col items-start gap-3">
            <div className="flex items-center gap-3">
              ...
              {following && !isCurrentUser && <div className="badge badge-primary">Following</div>}
            </div>
            {!isCurrentUser && <button className="btn btn-outline btn-white">Follow</button>}
          </div>
        </div>
        <div className="flex gap-3 items-center">
          ...
          <div className="stats">
            <div className="stat place-items-center">
              ...
              <div className="stat-value text-7xl">20</div>
            </div>
          </div>
        </div>
      </div>
