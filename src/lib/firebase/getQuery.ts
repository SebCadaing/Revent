import { collection, limit, orderBy, query, QueryDocumentSnapshot, startAfter, Timestamp, where, type Query } from "firebase/firestore";
import type { CollectionOptions } from "../types";
import { db } from "./firebase";

export const getQuery = (path: string, options?: CollectionOptions, lastDocRef?: QueryDocumentSnapshot | null, paginate?: boolean): Query => {
